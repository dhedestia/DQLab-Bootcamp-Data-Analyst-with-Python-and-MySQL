CREATE DATABASE dqlabmartbasic;
...
VALUES ('dqlabcust00',0,'Pelanggan Non Member',NULL),
...
VALUES ('prod-01',1,'Alat Tulis Kantor','Kotak Pensil DQLab',62500),
...
VALUES ('1','tr-001','dqlabcust07','2020-05-01 00:00:00',1,'prod-01','Kotak Pensil DQLab',5,62500,0),
('2','tr-001','dqlabcust07','2020-05-01 00:00:00',2,'prod-03','Flash disk DQLab 32 GB',1,100000,25),
('3','tr-001','dqlabcust07','2020-05-01 00:00:00',3,'prod-09','Buku Planner Agenda DQSQuad',3,92000,0),
...
('6','tr-002','dqlabcust00','2020-05-01 00:00:00',2,'prod-10','Sticky Notes DQLab 500 sheets',4,55000,0),
...
('9','tr-004','dqlabcust03','2020-05-03 00:00:00',1,'prod-10','Sticky Notes DQLab 500 sheets',5,55000,0),
('10','tr-004','dqlabcust03','2020-05-03 00:00:00',2,'prod-04','Flashdisk DQLab 32 GB',4,40000,0),
('11','tr-005','dqlabcust00','2020-06-12 00:00:00',1,'prod-09','Buku Planner Agenda DQSQuad',3,92000,0),
...
SHOW CREATE TABLE ms_pelanggan_dqlab;

DESCRIBE ms_produk_dqlab;
SHOW CREATE TABLE ms_produk_dqlab;

DESCRIBE tr_penjualan_dqlab;
SHOW CREATE TABLE tr_penjualan_dqlab;